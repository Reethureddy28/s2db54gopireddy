...
router.get('/', function (req, res) { 
    res.render('index', { title: 'popcorn App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'popcorn App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'popcorn App Login', user : req.user }); 
}); 
